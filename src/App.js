...
function App() {
  ...
  //Al hacer clic en el boton "eliminar" esta funcion re-renderiza todos los elementos "todo" que tengan el valor "selected: false" asi borrando los que tengan el valor "selected: true".
